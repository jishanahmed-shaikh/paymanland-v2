...
function PaymanPaymentInterface({ targetPlayer, currentPlayer, onPaymentComplete, onClose }) {
  ...
  const handlePayment = async (e) => {
    ...
    try {
      ...
      if (response) {
        // Consider any response as success for simplicity
...
export default PaymanPaymentInterface; 